...
const Destination=(props)=>{
    ...
    return(
        ...
        {props.destinations.map((destination, index)=>
            <div key={index} className="col-md-3" onClick={(e)=>openModal(index)}>
                <div className="row">
            ...
            <Modal.Body>
                <div className="row">
                    <div className="col-md-3 border_line">
                        <center>
                            <img className="line_image" src={props.destinations.length > 0 ? props.destinations[selectedDestination].images.left : null}/>
                        </center>
                    </div>
                    <div className="col-md-9">
                        <Modal.Header closeButton style={{whiteSpace: 'nowrap'}}>
                            <Modal.Title>{props.destinations.length > 0 ? props.destinations[selectedDestination].name + ' Customization' : ''}</Modal.Title>
                        </Modal.Header>
                        <div style={{marginTop: '20px'}}>
                            <div className="row">
                                <div className="col-md-12">
                                    {props.destinations.length > 0 ? props.destinations[selectedDestination].settings_available.map((item)=>
                                        <div key={item} className="navigation_section next">
                                            <div className="row">
                                                ...
                                                <i className="fa fa-2x fa-chevron-right styling_inter_fixing" aria-hidden="true"></i>
                                                </div>
                                            </div>
                                        </div>
                                    ): null}
